...
public class DipentendeController {
    ...
    private Dipendente findByIdAndUpdate(@PathVariable UUID  dipendenteId, @RequestBody Dipendente updatedDipendente){
        return dipendenteService.findByIdAndUpdate(dipendenteId,updatedDipendente);
    }
